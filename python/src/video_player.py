...
class VideoPlayer:
    ...
    def show_all_videos(self):
        ...
        for video in all_videos:
            ...
            tags = tags.strip()
            tags += "]"
            unsorted_videos += [f"{video.title} ({video.video_id}) {tags}"]
        sorted_videos = sorted(unsorted_videos)
        for clips in sorted_videos:
            print(clips)
    ...
    def stop_video(self):
        ...
        present_video = self._current_video
        if present_video:
            print(f"Stopping video: {self._current_video.title}")
            self._current_video = None
        else:
    ...
    def continue_video(self):
        ...
        if self.pause_vid == True:
            print(f"Continuing video: {self._current_video.title}")
        if self._current_video == None:
            print("Cannot continue video: No video is currently playing")
        if self.pause_vid == False and self._current_video != None:
